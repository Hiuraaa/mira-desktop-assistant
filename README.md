...
Mira không âm thầm theo dõi màn hình hoặc nghe microphone. Bot Telegram và chat điện thoại được phép tra cứu web khi bạn bật tính năng này, nhưng **không có quyền chụp màn hình hoặc điều khiển máy**. Các trang web, ảnh và file có thể chứa hướng dẫn sai cho AI; hãy xem kỹ hành động trước khi duyệt.
